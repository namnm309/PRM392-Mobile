        ...
        >
          <View style={styles.brandSection}>
            <View style={styles.logoContainer}>
              <Image
                source={require("../../assets/images/login/anhlogin (1).png")}
          ...
          {showMfaStep ? (
            <View style={styles.form}>
              ...
              >
                Clerk yêu cầu thêm bước xác minh. Nhập mã 6 số từ ứng dụng xác
                thực (Google Authenticator, Authy…) hoặc backup code.
              </Text>
              ...
              <TextInput
                ...
                onChangeText={(t) => {
                  setMfaCode(
                    useBackupCode ? t : t.replace(/\D/g, "").slice(0, 6),
                  );
                  setError("");
                }}
